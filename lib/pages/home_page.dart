                      ...
                      child: Column(
                        ...
                        children: <Widget>[
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: sw < 1100
                                  ? 26 * 0.15 * sh / 110 < 26 * 80 / 110
                                      ? 26 * 80 / 110
                                      : 26 * 0.15 * sh / 110 > 26 * 110 / 110
                                          ? 26
                                          : 26 * 0.15 * sh / 110
                                  : 36 * 0.15 * sh / 110 < 36 * 80 / 110
                                      ? 36 * 80 / 110
                                      : 36 * 0.15 * sh / 110 > 36 * 110 / 110
                                          ? 36
                                          : 36 * 0.15 * sh / 110,
                          ...
                          Text(
                            ...
                            style: TextStyle(
                              fontSize: sw < 1100
                                  ? 18 * 0.15 * sh / 110 < 18 * 80 / 110
                                      ? 18 * 80 / 110
                                      : 18 * 0.15 * sh / 110 > 18 * 110 / 110
                                          ? 18
                                          : 18 * 0.15 * sh / 110
                                  : 24 * 0.15 * sh / 110 < 24 * 80 / 110
                                      ? 24 * 80 / 110
                                      : 24 * 0.15 * sh / 110 > 24 * 110 / 110
                                          ? 24
                                          : 24 * 0.15 * sh / 110,
                              color: MyColors.textColor1,
  ...
  Widget build(BuildContext context) {
    return CarouselSlider.builder(
      ...
      itemBuilder: (ctx, index) => Container(
        height: 0.8 * (MediaQuery.of(context).size.height - 50),
